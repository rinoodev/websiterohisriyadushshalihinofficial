...
// Department values for filtering on the homepage.
export const galeriData: GalleryImage[] = [
  { id: 1, imageUrl: 'img/Humas.jpeg', caption: 'Program: Kerja Departemen Humas', department: 'Humas' },
